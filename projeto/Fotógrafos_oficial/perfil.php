  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="update.php?cod_usuario=<?php print $_SESSION['cod_usuario']?>">EDITAR</a></li>
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container">
    ...
    <h4><b><?php print $_SESSION['nome_completo'] ?></b></h4>
  </div>
  ...
  <div class="w3-panel w3-large">
    <a href=<?php print $_SESSION['face'] ?>><i class="fa fa-facebook-official w3-hover-opacity"></i></a>
    <a href=<?php print $_SESSION['insta'] ?>><i class="fa fa-instagram w3-hover-opacity"></i></a>
    <a href=<?php print $_SESSION['linkedin'] ?>><i class="fa fa-linkedin w3-hover-opacity"></i></a>
  </div>
</nav>
